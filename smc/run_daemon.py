...
class Daemon:
    ...
    def _entry_enabled(self) -> bool:
        ...
        return ceiling is None or self._entry_submission_count < ceiling
    ...
    def _submit_entry(self, attempt, selection):
        ...
        # A transport timeout has unknown fate, so it consumes the canary
        # allowance before network I/O and can never invite a second POST.
        self._entry_submission_count += 1
